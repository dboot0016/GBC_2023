...
FIG_NR = '2','S3','S2','S4','S5','9','4','S7','S8','S9','S6','S16','S12','S13','S11'
...
for NN in range(1):#len(VARS)):
    ...
    Vmn1=([-3.1,-5.1,-0.06,-0.26,-0.26,-1.6e-9,-5.6e-10,-3.1,-5.1,-5.1,-1.6e-7,-0.078,-40,-50,-0.078])
    Vmx1=([3.1,5.1,0.06,0.26,0.26,1.6e-9,5.6e-10,3.1,5.1,5.1,1.6e-7,0.078,40,50,0.078])
    ...
    #%%
    # Select bounds for color scheme
    Vmn1=([-7.1,-5.1,-0.06,-0.26,-0.26,-4.6e-9,-9.6e-10,-5.1,-5.1,-5.1,-2.1e-7,-0.5,-40,-50,-0.078])
    Vmx1=([7.1,5.1,0.06,0.26,0.26,4.6e-9,9.6e-10,5.1,5.1,5.1,2.1e-7,0.5,40,50,0.078])
    ...
    #%%
    # Select bounds for color scheme
    Vmn1=([-3.1,-5.1,-0.06,-0.26,-0.26,-4.6e-9,-9.6e-10,-3.1,-5.1,-5.1,-2.1e-7,-0.078,-20,-50,-0.078])
    Vmx1=([3.1,5.1,0.06,0.26,0.26,4.6e-9,9.6e-10,3.1,5.1,5.1,2.1e-7,0.078,20,50,0.078])
