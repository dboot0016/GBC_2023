...
for NN in range(len(VARS)):
    ...
    subplot(VAR3_gr1,VAR3_gr2,VAR4_gr1,VAR4_gr2,8,scen)
    ...
    scen = '126'
    fig = plt.figure(figsize=(7, 5))
    subplot(VAR1_gr1,VAR1_gr2,VAR2_gr1,VAR2_gr2,8,scen)
    ...
    i = 8 # Which decade; select -1 for Diff CTL last 5 yrs. w.r.t first 5 yrs -2 for DIFF HOS
    fig = plt.figure(figsize=(7, 5))
    subplot(VAR3_gr1,VAR3_gr2,VAR4_gr1,VAR4_gr2,-1,scen)
    ...
    scen = '126'
    fig = plt.figure(figsize=(7, 5))
    subplot(VAR1_gr1,VAR1_gr2,VAR2_gr1,VAR2_gr2,-1,scen)
    ...
    i = 8 # Which decade; select -1 for Diff CTL last 5 yrs. w.r.t first 5 yrs -2 for DIFF HOS
    fig = plt.figure(figsize=(7, 5))
    subplot(VAR3_gr1,VAR3_gr2,VAR4_gr1,VAR4_gr2,-2,scen)
    
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_'+str(fig_nr)+'_extra_diff_HOS_585.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    scen = '126'
    fig = plt.figure(figsize=(7, 5))
    subplot(VAR1_gr1,VAR1_gr2,VAR2_gr1,VAR2_gr2,-2,scen)
    
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_'+str(fig_nr)+'_extra_diff_HOS_126.png', format='png', dpi=quality,bbox_inches='tight')
