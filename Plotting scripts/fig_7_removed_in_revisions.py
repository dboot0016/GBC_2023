...
#%%
total_dx=((VAR1_gr1['PO4'].count(['lon']))*dx)
...
#%%
total_dx=(((VAR1_gr1['PO4']*mask1).count(['lon']))*dx)
...
#%%
total_dx=(((VAR1_gr1['PO4']*mask2).count(['lon']))*dx)
...
for n in range(1):
    ...
    if n == 0:
        VAR1_gr1 = VAR1_glob1['PO4']
        VAR2_gr1 = VAR2_glob1['PO4']
        VAR3_gr1 = VAR3_glob1['PO4']
        VAR4_gr1 = VAR4_glob1['PO4']
        
        VAR1_gr2 = VAR1_glob2['PO4']
        VAR2_gr2 = VAR2_glob2['PO4']
        VAR3_gr2 = VAR3_glob2['PO4']
        VAR4_gr2 = VAR4_glob2['PO4']
        
    elif n == 1:
        VAR1_gr1 = VAR1_atl1['PO4']
        VAR2_gr1 = VAR2_atl1['PO4']
        VAR3_gr1 = VAR3_atl1['PO4']
        VAR4_gr1 = VAR4_atl1['PO4']
        
        VAR1_gr2 = VAR1_atl2['PO4']
        VAR2_gr2 = VAR2_atl2['PO4']
        VAR3_gr2 = VAR3_atl2['PO4']
        VAR4_gr2 = VAR4_atl2['PO4']
        
    elif n == 2:
        VAR1_gr1 = VAR1_pac1['PO4']
        VAR2_gr1 = VAR2_pac1['PO4']
        VAR3_gr1 = VAR3_pac1['PO4']
        VAR4_gr1 = VAR4_pac1['PO4']
        
        VAR1_gr2 = VAR1_pac2['PO4']
        VAR2_gr2 = VAR2_pac2['PO4']
        VAR3_gr2 = VAR3_pac2['PO4']
        VAR4_gr2 = VAR4_pac2['PO4']
    
    Vmn1 = ([-0.00055,-0.00055,-0.00055])
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7f.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7c.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7e.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7b.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_diff_HOS_585.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_diff_HOS_126.png', format='png', dpi=quality,bbox_inches='tight')
        
    Vmn1 = ([0.0005,0.0005,0.0005])
    Vmx1 = ([0.0035,0.0035,0.0035])
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7d.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_HOS_585_2016.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_CTL_585_2096.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_HOS_585_2096.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7a.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_HOS_126_2016.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_CTL_126_2096.png', format='png', dpi=quality,bbox_inches='tight')
    ...
    if save_fig == 'yes':
        plt.savefig(datadir+'fig_7_extra_HOS_126_2096.png', format='png', dpi=quality,bbox_inches='tight')
